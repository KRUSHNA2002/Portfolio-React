...
const MyCertificate=[
    ...
    {cover:`${jquery}` ,name:"JQUERY" ,link:'https://drive.google.com/file/d/1hkBe6tvdAT_AkUgqp3Hwa49qTmgTfsve/view?usp=sharing',desc:"Mastering DOM Manipulation: A2Z Infotech PVT.LTD certification, a testament to my jQuery prowess."},
    {cover:`${javascript}` ,name:"JAVASCRIPT" ,link:'https://drive.google.com/file/d/1IDVKeV3td1Zu5xaB-_zZDpLvrrPosyDk/view?usp=sharing',desc:"Certified Scripter: Grateful for the recognition of JavaScript skills gained at A2Z Infotech PVT.LTD."},
    {cover:`${html}` ,name:"HTML" ,link:'https://drive.google.com/file/d/1GbkJbJDHw8ABP4s6hNHAhkEwhNwBH5ab/view?usp=sharing',desc:"Code Crafting Journey: A2Z Infotech PVT.LTD certification, marking a milestone in HTML proficiency."},
